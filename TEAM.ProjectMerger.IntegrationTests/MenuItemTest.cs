...
namespace TEAM.ProjectMerger_IntegrationTests
{
   [TestClass()]
   public class MenuItemTest
   {
      ...
      public void LaunchCommand()
      {
         ...
         {
            CommandID menuItemCmd = new CommandID(TEAM.TEAM_ProjectMerger.GuidList.guidTEAM_ProjectMergerCmdSet, (int)TEAM.TEAM_ProjectMerger.PkgCmdIDList.teamMergeProjects);

            // Create the DialogBoxListener Thread.
            string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TEAM.ProjectMerger", "TEAM.TEAM_ProjectMerger.TEAM_ProjectMergerPackage");
